	...
	<?php endif; // true ==== $et_top_info_defined ?>
		...
		<header id="main-header" class="<?php echo esc_attr( $primary_nav_class ); ?>">
			...
			?>
				...
				<a href="http://comminfo.rutgers.edu/" class="nwlg">
					<img src="<?php echo esc_attr( $logo ); ?>" alt="<?php echo esc_attr( get_bloginfo( 'name' ) ); ?>" id="logo" />
						...
						<span id="et_search_icon" style="display:none;" ></span>
						<form  role="search" style="display:block;" method="get" class="et-search-form" action="<?php echo esc_url( home_url( '/' ) ); ?>">
						<?php
printf( '<input type="search" class="et-search-field" placeholder="%1$s" value="%2$s" name="s" title="%3$s" /><input type="submit" class="icon_new">',
					...
					<?php endif; // true === et_get_option( 'show_search_icon', false ) ?>
                           ...
                           <div class="titleundlo"><a href="<?php echo site_url(); ?>"><?php echo get_bloginfo('name'); ?></a></div>
                    <div class="clear"></div>        
				...
				<div id="et-top-navigation" class="some">
